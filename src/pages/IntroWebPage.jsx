...
const BiometricBubbleIllustrator = () => {
    return (
        <div className="relative w-[280px] h-[280px] sm:w-[320px] sm:h-[320px] md:w-[400px] md:h-[400px] shrink-0 flex items-center justify-center mx-auto">
...
const IntroWebPage = () => {
    ...
    // PERBAIKAN: Gunakan useRef untuk mencegah browser menghapus objek suara sebelum selesai (Garbage Collection bug)
        ...
        const speakCurrentStep = () => {
            if ('speechSynthesis' in window) {
                ...
                if (!userHasInteracted) {
                    if (step === 0) {
                        // Jika tidak ada interaksi, biarkan sedikit lebih lama sebelum skip
                ...
                // PERBAIKAN: Simpan utterance ke ref agar tidak terpotong oleh sistem browser
                ...
                if (step === 0) {
                    ...
                    // PERBAIKAN UTAMA: Naikkan fallback timer dari 4500ms jadi 10000ms.
                    // Ini memastikan timer ini hanya bekerja jika event onend benar-benar error/gagal,
                    // dan bukan memotong paksa saat suara sedang berjalan.
                    fallbackTimer = setTimeout(safeProceed, 10000);
                }
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        <div className="space-y-2 md:space-y-4 w-full flex flex-col items-center">
                            ...
                            {step === 0 && (
                                <div
                                    className={`transform transition-all duration-500 ease-in-out w-full flex justify-center items-center
                                        ${isPopping ? 'opacity-0 scale-125 blur-md' : 'opacity-100 scale-100 blur-none'}
                                    `}
                                >
