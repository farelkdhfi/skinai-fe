...
import { useCurrentAnalysis } from '../../analysis/useCurrentAnalysis';
import { useSaveAnalysisHistory } from '../../analysis/useSaveAnalysisHistory';
...
export default function Results() {
    ...
    // PERUBAHAN 2: baca hasil analisis dari cache TanStack Query, bukan context
    const { results, patches, recommendations } = useCurrentAnalysis();
    const { isAuthenticated } = useAuth();

    // PERUBAHAN 3: saveToHistory() dari context -> useMutation
    const saveHistoryMutation = useSaveAnalysisHistory();
    const isSaved = saveHistoryMutation.isSuccess;
    const isSaving = saveHistoryMutation.isPending;
    ...
    // PERUBAHAN 4: handleSave sekarang mengirim results/patches/recommendations
    // secara eksplisit ke mutation (dulu dibaca langsung dari dalam context)
