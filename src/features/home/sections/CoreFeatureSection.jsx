...
import patchImg from '../../../assets/others/patch.jpg';
import heatmapImg from '../../../assets/others/heatmap.jpg';

import VideoDemo from '../../../assets/videos/demo.mp4';
import { TECH_STACK } from '../../../data/data';
import CardStackItem from '../components/CardStackItem';

const CoreFeatureSection = () => {
    return (
        <section className="relative z-10 py-12 md:py-20 px-4 sm:px-6 md:px-16 bg-neutral-950 text-white">
